...
const Testimonial = () => {
  return (
    ...
    <div className="flex flex-col w-[1280px] h-auto top-[5886px] pt-[112px] px-[64px] pb-[112px] pl-[64px] gap-[80px] bg-[#F7F7F7] mobile:px-[24px] mobile:pt-[48px] mobile:pb-[48px] mobile:pl-[24px]">
      <div className="flex flex-col gap-[24px]">
        <h1 className="font-[Roboto] text-[48px] font-bold text-[#000000] mobile:text-[32px] mobile:ml-8">Customer testimonials</h1>
        <p className="w-[560px] font-[Roboto] text-[18px] font-thin mobile:w-[361px] mobile:text-center ml-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
      </div>

      {/* 2nddiv */}
      <div className="h-auto gap-[48px] flex flex-col mobile:gp-[24px]">
        <div className=" flex w-[1312px] gap-[32px] mobile:flex-col">
            <div className=" flex flex-col border-[1px] p-[32px] gap-[24px] border-[#000000] mobile:w-[380px]">
             <Image
           ...
           <div className="w-[1312px] mobile:w-[380px] flex justify-between">
